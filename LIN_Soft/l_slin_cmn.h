...
/***** 定数定義 *****/
/* エラー発生 */
#define  U4G_LIN_UART_ERR_OVERRUN   (0x00000008)             /* オーバーランエラー検出        */
#define  U4G_LIN_UART_ERR_BREAK     (0x00000004)             /* ブレークエラー検出            */
#define  U4G_LIN_UART_ERR_PARITY    (0x00000002)             /* パリティエラー検出            */
#define  U4G_LIN_UART_ERR_FRAMING   (0x00000001)             /* フレーミングエラー検出        */
...
/* flush rx使用/未使用(unsigned char型) */
#define  U1G_LIN_FLUSH_RX_NO_USE          ((l_u8)0)       /* flush rx未使用 */
#define  U1G_LIN_FLUSH_RX_USE             ((l_u8)1)       /* flush rx使用   */
...
/* システム異常フラグ */
#define  U1G_LIN_SYSERR_STAT        ((l_u8)1)       /**< @brief  LINステータスが規定値以外 型: u1 */
#define  U1G_LIN_SYSERR_DIV         ((l_u8)2)       /**< @brief  0除算発生 型: u1 */
#define  U1G_LIN_SYSERR_DRIVER      ((l_u8)3)       /**< @brief  MCUステータス異常 型: u1 */
